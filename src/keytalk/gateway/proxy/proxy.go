...
func (s *Server) handle(conn net.Conn) {
	...
	for {
		...
		log.Info("%s %s %s %s %s %d %s", tlscon.RemoteAddr(), subjectName, req.URL.String(), req.Header.Get("Content-Type"), resp.Header.Get("Content-Length"), resp.StatusCode, req.Header.Get("Referer"))
